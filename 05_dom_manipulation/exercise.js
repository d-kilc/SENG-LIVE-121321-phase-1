const what = 'MAKE SURE TO FILL ME IN!!!';
...
document.body.querySelector('button').addEventListener('click',()=>loadTodoList(todoList));
...
document.body.querySelector('#add').addEventListener('click',() => {
  ...
  addTask(todoList, {
    label: document.body.querySelector('#new-task').value,
    dueDate: document.body.querySelector('#new-duedate').value
  })
})
