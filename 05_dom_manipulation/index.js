...
const playlist = [
  ...
  },
  {
    ...
    duration: 213,
    playCount: 0,
    youtubeLink: 'https://www.youtube.com/watch?v=xm3YgoEiEDc&ab_channel=10Hours'
  },
  {
    id: 2,
    name: 'Cry Me a River',
...
function loadPlaylistToSidebar(playlist) {
  ...
  // into the sidebar
  document.querySelector('#playlist').innerHTML = null
...
window.setTimeout(() => {
  console.log('removeSongFromPlaylist', removeSongFromPlaylist(playlist, '8'))
  console.log('playlist after addSongToPlaylist', copy(playlist))
}, 4000)
...
function loadSongIntoPlayer(song) {
  ...
  document.querySelector('#play-count').textContent = song.playCount
  ...
  document.querySelector("#player-frame").src = song.youtubeLink
}

//document.querySelectorAll('li').addEventListener("click", loadSongIntoPlayer)
